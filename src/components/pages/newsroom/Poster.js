            ...
            <div className='pt-10'>
              ...
              <button className='bg-secondary text-base md:text-xs lg:text-base text-white font-bold md:font-medium lg:font-bold mt-8 py-3 px-6 rounded-full inline-flex items-center'>
                ...
                <svg width="23" height="16" className='ml-4' viewBox="0 0 23 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15.1992 2L21.1992 8L15.1992 14" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M21.2 8H2" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
            </div>
          </div>
