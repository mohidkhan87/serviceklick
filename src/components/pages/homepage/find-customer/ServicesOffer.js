                    ...
                    <div className='flex-1 md:px-8'>
                        ...
                        <p className='text-primary mt-4 text-lg underline font-bold flex items-center gap-2'>
                            ...
                            <svg width="18" height="11" viewBox="0 0 18 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.5067 5.31757C9.72567 6.09862 8.45934 6.09862 7.67829 5.31757L3.33992 0.979199C2.72499 0.364277 1.72801 0.364277 1.11309 0.979199C0.498163 1.59412 0.498164 2.59111 1.11309 3.20603L7.97915 10.0721C8.59407 10.687 9.59106 10.687 10.206 10.0721L11.3194 8.95871C11.3194 8.95869 11.3194 8.95866 11.3194 8.95865C11.3194 8.95863 11.3194 8.9586 11.3194 8.95859L17.0721 3.20588C17.687 2.59096 17.687 1.59397 17.0721 0.979052C16.4571 0.36413 15.4602 0.364129 14.8452 0.979052L10.5067 5.31757Z" fill="#2B2D33" />
                            </svg>
